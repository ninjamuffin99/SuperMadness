...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/replay.fgr", __ASSET__assets_data_replay_fgr);
		type.set ("assets/data/replay.fgr", AssetType.TEXT);
		className.set ("assets/images/images-go-here.txt", __ASSET__assets_images_images_go_here_txt);
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		className.set ("assets/images/placeholder BG.png", __ASSET__assets_images_placeholder_bg_png);
		type.set ("assets/images/placeholder BG.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/images/placeholder BG.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_replay_fgr extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_placeholder_bg_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/replay.fgr") #if display private #end class __ASSET__assets_data_replay_fgr extends lime.utils.Bytes {}
@:file("assets/images/images-go-here.txt") #if display private #end class __ASSET__assets_images_images_go_here_txt extends lime.utils.Bytes {}
@:image("assets/images/placeholder BG.png") #if display private #end class __ASSET__assets_images_placeholder_bg_png extends lime.graphics.Image {}
